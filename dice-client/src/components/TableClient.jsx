...
function TableHeader({ children, className }) {
  ...
  return (
    <div
      className={cn(
        `bg-transparent text-[#b4b3b3] text-sm lg:text-lg grid ${columns} w-full py-2 font-extralight border-b border-[#a7a5a5]`,
        className
      )}
    >
      {children}
  ...
  return (
    <TableContext.Provider value={{ columns }}>
      <PerfectScrollbar>
        <div
          role="table"
          className="min-w-[40rem] lg:w-full rounded-lg overflow-x-auto"
        >
          {children}
        </div>
      </PerfectScrollbar>
