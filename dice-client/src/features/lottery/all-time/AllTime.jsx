  ...
  return (
    <div className="text-white">
      <div className="flex justify-end gap-10">
        <div className="self-end md:text-lg text-center bg-[#753d89] border border-[#955997] rounded-2xl px-8 py-2">
          <h4 className="uppercase">Total Tickets Purchased</h4>
          <p className="flex items-center text-left uppercase gap-2">
            <span className="w-[180px]">Standard tickets</span>
          ...
          <p className="flex items-center text-left uppercase gap-2">
            <span className="w-[180px]">Mega tickets</span>
            <div className="flex items-center gap-2 text-left">
        ...
        <div className="flex flex-col gap-2">
          <div className="md:text-lg text-center bg-[#753d89] border border-[#955997] rounded-2xl px-8 py-2">
