...
function MyHistory() {
  ...
  return (
    <div className="text-white">
      <div className="absolute top-20 tablet:top-4 right-12 tablet:right-8 w-[240px] tablet:w-[220px] desktop:w-[300px] text-sm desktop:text-lg text-center bg-[#753d89] border border-[#955997] rounded-2xl px-8 py-1 space-y-2 tablet:space-y-0">
      ...
      >
        ...
        <div className="flex items-center gap-2 mt-4 tablet:mt-0">
          <button
            className={cn(
              "text-white text-sm tablet:text-base px-3 tablet:px-6 py-1 tablet:py-2 rounded-xl shadow-xl border border-[#8e758f]",
