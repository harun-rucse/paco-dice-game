...
function ProfileInfo() {
  ...
  return (
    <div className="bg-[#1e1c3a] dark:bg-[#31294c] text-white flex flex-col gap-2 px-6 tablet:px-10 py-6 rounded-xl shadow-xl">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-end justify-between gap-1 tablet:gap-2">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="bg-transparent py-2 rounded-lg text-lg font-extralight cursor-pointer focus:border border-[#4b5563] focus:outline-none"
            />
          </div>
          <button
            className="bg-[#413e72] dark:bg-[#3a2354] border border-[#605e96] dark:border-[#533378] text-sm uppercase font-extralight px-4 py-2 rounded-xl"
